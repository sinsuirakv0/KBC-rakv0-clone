...
- 端末のABI確認
- XAPKの自動検索
- APKComboの本家最新版XAPK取得画面を開き、取得したXAPKを自動選択
...
XAPK選択画面の`d`を選ぶと、APKComboの本家最新版の取得画面を開きます。ブラウザでXAPKをダウンロードしてTermuxへ戻ると、今回取得したXAPKを選択します。取得したファイルの`manifest.json`から版番号も確認します。
